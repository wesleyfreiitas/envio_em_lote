<?php if (!isset($_GET['editar'])) { ?>
	...
	<form method="post" action="processa_instancia.php">
		...
		<input class="form-control" type="hidden" name="usuario" value="<?php echo $usuario ?>">
		<br><br>
		...
		<input class="form-control" type="text" name="token" placeholder="Insira o token">
		<br><br>
		<label class="badge badge-secondary">Número:</label><br>
		<input class="form-control" type="text" name="numero" placeholder="Insira o numero 5511999999999">
		<br><br>
	...
	<?php while ($linha = mysqli_fetch_array($consulta_instancias)) { ?>
		<?php if ($linha['id_instancia'] == $_GET['editar']) { ?>
			...
			<form method="post" action="edita_instancia.php">
				...
				<br><br>
				<label class="badge badge-secondary">Token:</label><br>
				<input class="form-control" type="text" name="token" placeholder="Insira o Token" value="<?php echo $linha['token']; ?>">
				<br><br>
				<label class="badge badge-secondary">Número:</label><br>
				<input class="form-control" type="text" name="numero" placeholder="Insira o numero 5511999999999" value="<?php echo $linha['numero']; ?>"><br><br>
