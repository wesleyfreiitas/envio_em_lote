...
--
-- Host: 127.0.0.1
-- Tempo de geração: 23-Maio-2023 às 00:41
...
CREATE TABLE `envios` (
  ...
  `arquivo` varchar(244) DEFAULT NULL
...
INSERT INTO `envios` (`id_envio`, `mensagem`, `instancia`, `token`, `arquivo`) VALUES
(0, 'asdasdasd', 'asdasdasd', 'asdasdasd', '');
